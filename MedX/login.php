...
<body>
    <div class="wrapper">
        <h2 data-aos="fade-down" center>Login</h2>
        <div data-aos="fade-down" center>
        <i icon style="font-size: 60px !important; color: var(--accent) !important;" >lock_open</i>
        </div>
        <H5 data-aos="fade-up" center>Please fill in your credentials to login.</H5>
        <form data-aos="fade-up" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div center class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
            ...
            <div center class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                 <label class="textfield outlined">
            ...
            <div center class="form-group">
                <input type="submit" btn class="btn btn-primary" value="Login">
            </div>
            <p center>Don't have an account? <a href="register.php">Sign up now</a>.</p>
        </form>
    </div> 
